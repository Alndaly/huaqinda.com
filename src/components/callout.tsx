...
import GitHubWarningIcon from '@/components/icon/github-warning.svg';
import GitHubCautionIcon from '@/components/icon/github-caution.svg';
import GitHubTipIcon from '@/components/icon/github-tip.svg';
import GitHubImportantIcon from '@/components/icon/github-important.svg';
import GitHubNoteIcon from '@/components/icon/github-note.svg';
